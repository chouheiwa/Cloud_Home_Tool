...
//    }]];
//
    [alertController addAction:[UIAlertAction actionWithTitle:@"UUID变更" style:(UIAlertActionStyleDefault) handler:^(UIAlertAction * _Nonnull action) {
        [self changeDeviceId];
    }]];
...
- (void)changeDeviceId {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"请输入希望更换的UUID" preferredStyle:(UIAlertControllerStyleAlert)];
    
    [alert addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        NSString *string = [NSClassFromString(@"UIDevice") performSelector:NSSelectorFromString(@"uniqueDeviceIdentifier") withObject:nil];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"更改" style:(UIAlertActionStyleDefault) handler:^(UIAlertAction * _Nonnull action) {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:string forKey:@"WD_UUID_KEY"];
    }]];
